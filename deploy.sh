...
docker-machine start worker4vm
docker-machine ls
...
docker-machine ssh worker4vm "mkdir pg-init-scripts"
...
docker-machine scp pg-init-scripts/create-multiple-postgresql-databases.sh worker4vm:~/pg-init-scripts
