package rsoi.lab2.taskservice.conf.jwt;
...
import rsoi.lab2.taskservice.conf.WebConfig;
import rsoi.lab2.taskservice.model.TokenObject;
import rsoi.lab2.taskservice.exception.jwt.JwtAuthenticationException;
...
public class JwtTokenProvider {
    ...
    public TokenObject getToken(HttpServletRequest req) {
        ...
        if (auth != null && auth.startsWith("Basic ")) {
            ...
            if (basic.replaceAll(" ", "").contains(base64)) {
                ...
                claims.put("name_service", "Task Service");
    ...
    public boolean validateToken(String token) {
        try {
            ...
            if (!appId.equals(WebConfig.getGatewayKey()) || !nameService.equals("Task Service")) {
