package rsoi.lab2.testservice.conf.jwt;
...
import rsoi.lab2.testservice.conf.WebConfig;
import rsoi.lab2.testservice.exception.jwt.JwtAuthenticationException;
import rsoi.lab2.testservice.model.TokenObject;
...
public class JwtTokenProvider {
    ...
    public TokenObject getToken(HttpServletRequest req) {
        ...
        if (auth != null && auth.startsWith("Basic ")) {
            ...
            if (basic.replaceAll(" ", "").contains(base64)) {
                ...
                claims.put("name_service", "Test Service");
    ...
    public boolean validateToken(String token) {
        try {
            ...
            if (!appId.equals(WebConfig.getGatewayKey()) || !nameService.equals("Test Service")) {
