...
import rsoi.lab2.teservice.conf.WebConfig;
import rsoi.lab2.teservice.exception.jwt.JwtAuthenticationException;
import rsoi.lab2.teservice.model.TokenObject;
...
public class JwtTokenProvider {
    ...
    public TokenObject getToken(HttpServletRequest req) {
        ...
        if (auth != null && auth.startsWith("Basic ")) {
            ...
            if (basic.replaceAll(" ", "").contains(base64)) {
                ...
                claims.put("name_service", "Task Executor Service");
    ...
    public boolean validateToken(String token) {
        try {
            ...
            if (!appId.equals(WebConfig.getGatewayKey()) || !nameService.equals("Task Executor Service")) {
