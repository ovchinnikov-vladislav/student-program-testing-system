package rsoi.lab5.seservice.controller;
...
import rsoi.lab5.seservice.model.*;
import rsoi.lab5.seservice.model.user.UserDto;
import rsoi.lab5.seservice.model.user.UserModel;
import rsoi.lab5.seservice.service.oauth.AuthorizationCodeService;
...
import rsoi.lab5.seservice.service.oauth.OAuthClientService;
...
public class SessionController {
    ...
    public AuthorizationCode getCode(@RequestParam(value = "response_type") String responseType,
        ...
        if (responseType.equals("code")) {
            ...
            if (token != null && jwtTokenProvider.validateAccessToken(token)) {
                UUID userId = jwtTokenProvider.getUserIdByToken(token);
    ...
    public UserModel findUserById(@PathVariable UUID id) {
    ...
    public UserDto createUser(@RequestBody User user) {
        ...
        return new UserDto().fromUser(result);
    }
